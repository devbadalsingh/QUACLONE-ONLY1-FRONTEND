...
const AadhaarCompare = ({ open, setOpen, aadhaarDetails }) => {
    console.log("aadhaar: ", aadhaarDetails);
    ...
    const getComparisonFields = (lead, aadhaarDetails) => {
        const { house, po, dist, state, country, street, pc } =
        ...
        const comparisonFields = [
            ...
            },
            {
                ...
                aadhaarValue: aadhaarDetails?.dob,
            },
            {
                label: "Gender",
            ...
            },
            {
                ...
                aadhaarValue: aadhaarDetails?.maskedAdharNumber,
            },
            {
                label: "Address ",
