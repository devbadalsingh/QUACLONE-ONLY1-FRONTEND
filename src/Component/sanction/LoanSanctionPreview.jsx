        ...
        {/* <KeyFactStatement /> */}
          <Container sx={{ padding: '20px', border: '1px solid #ddd' }}>
            ...
            <Box textAlign="center" mb={3}>
              <img
                src="https://ramleela.s3.ap-south-1.amazonaws.com/ONLY1LOAN+HEADER+AND+FOOTER/Only+1+letter+Head+Gradiant+copy+2.webp"
            ...
            <Typography variant="body2" fontWeight="bold" mb={2}>
              only1loan, a brand name under Naman Finlease Private Limited (RBI approved NBFC – Reg No.14.01466) D-190, Sector 74, Phase 8, Industrial Area, Mohali - 160071.
            </Typography>
            ...
            <Box>
              ...
              <Typography variant="body1" mb={2}>
                ...
                <a href="https://only1loan.com" target="_blank" rel="noopener noreferrer">
                  Only1Loan
                </a>
              </Typography>
            ...
            <Box textAlign="center" mt={3}>
              <img
                src="https://ramleela.s3.ap-south-1.amazonaws.com/ONLY1LOAN+HEADER+AND+FOOTER/Only+1+letter+Head+Gradiant+copy.webp"
                alt="Sanctionletter-footer"
                width="760"
                height="104"
                style={{ maxWidth: '100%' }}
