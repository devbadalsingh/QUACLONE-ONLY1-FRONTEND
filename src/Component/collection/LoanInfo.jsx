...
const LoanInfo = ({ disburse }) => {
    ...
    const sanction = applicationProfile?.sanction;
    const application = sanction?.application;
    const cam = application?.cam;
    const lead = application?.lead;

    const fName = lead?.fName || "";
    const mName = lead?.mName || "";
    ...
    const info = [
        ...
        { label: "Principle Amount", value: cam?.details?.loanRecommended },
        {
            ...
            value:
                cam?.details?.repaymentDate &&
                formatDate(cam?.details?.repaymentDate),
        },
        { label: "Repayment Amount", value: cam?.details?.repaymentAmount },
        {
            label: "Actual Repayment Amount",
            value: cam?.details?.repaymentAmount,
        },
